...
namespace se3
{
    ...
    __host__ __device__ Eigen::Vector3f qRotInv(Eigen::Vector4f q, Eigen::Vector3f v);

    __host__ __device__ Eigen::Vector4f qMul(Eigen::Vector4f q1, Eigen::Vector4f q2);
} // namespace se3
