...
namespace apbd
{
  ...
  public:
    ...
    __host__ __device__ bool broadphaseGround(Eigen::Matrix4f E, Eigen::Matrix4f Eg);
    // __host__ __device__ void narrowGround(Eigen::Matrix4f E);
    __host__ __device__ bool broadphaseShape(Eigen::Matrix4f E1, Shape *other, Eigen::Matrix4f E2);
